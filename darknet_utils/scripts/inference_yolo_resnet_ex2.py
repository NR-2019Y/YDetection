...
from yolo_resnet18_ex2 import YoloResnet18, yolo_dets_ex
...
def main():
    ...
    for imgp in image_paths:
        ...
        dets = yolo_dets_ex(preds, num_classes=num_classes, wh_scales=wh_scales).squeeze(0)
        dets = nms_dets(dets, conf_threshold=0.10, iou_threshold=0.45).numpy()
